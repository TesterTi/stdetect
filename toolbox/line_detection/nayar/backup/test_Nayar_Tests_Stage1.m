function test_Nayar_Tests_Stage1(max_val, projected_windowset, pcvec, coarse_to_fine)
...
%
%   stores results under the director specified by path.txt, i.e.
%   .\test_scripts\results\nayar\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    parfor i = 1:numel(filenamelist)
        ...
        response = test(spectrogram, projected_windowset, pcvec, coarse_to_fine, max_val);
...
function [response] = test(spectrogram, projected_windowset, pcvec, coarse_to_fine, max_val)
    
    fprintf('Running Detection...');
    response = parametric_detect(scale(spectrogram.z_spec, max_val, 255), projected_windowset, pcvec, coarse_to_fine);
    fprintf('Done\n');
