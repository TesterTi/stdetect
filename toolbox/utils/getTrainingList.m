function [pathlist, filenamelist] = getTrainingList()
...
PATH = [path1 'training_set' filesep 'V' filesep];
for i = 1:2
...
PATH = [path1 'training_set' filesep 'N' filesep];
for i = 1:10
    pathlist{count}     = PATH;
...
for j = 1:numel(sinusoid)
    PATH = [path1 'training_set' filesep sinusoid{j} filesep];
    for i = 1:2
        for amplitude = 1:5
            for SNR = 0:0.5:8
                pathlist{count}     = PATH;
